...
.forgot-password:focus{
    ...
    <div class="container">
    <h1 class="welcome text-center">Reservation of Meeting Rooms</h1>
        <div class="card card-container">
        <h2 class='login_title text-center'>Login</h2>
        <hr>

            <form class="form-signin" action="http://10.88.2.206/authenticate.php" method="post">
                <span id="reauth-email" class="reauth-email"></span>
                <p class="input_title">HEC Login</p>
                <input type="text" id="inputEmail" name="u" class="login_box" required>
                <p class="input_title">Password</p>
                <input type="password" id="inputPassword" name="p" class="login_box" placeholder="******" required>
