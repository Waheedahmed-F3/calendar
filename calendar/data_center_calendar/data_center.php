...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="data_center.php">Data Center Calendar View</a>
    </div>
...
<div class="container">
	...
	<div class="page-header">
		...
		<div class="btn-group">
			...
			<select onchange="location = this.value;"class="form-control dropdown">
				<option value="data_center.php">Data Center</option>
				<option value="../calendar.php">Lecture Hall</option>
	...
	<div class="row">
		...
		<div class="span3">
			...
			<h4>Events</h4>
			<small>List is of Scheduled events.</small>
